...
<section class="section flex m-20">
    <div class="container">
        <div class="intro has-text-centered">
            <img src="/images/icons/sprinkler.png" class="mb-20" alt="">
            <h1 class="title mb-20 is-uppercase fs-15">Beregeningen Particulier</h1><br>
            <h2 class="subtitle mb-20">Tuinberegeningen | Paardenpiste beregeningen
</h2>
    ...
    <div class="container">
        <div class="intro has-text-centered">
            ...
            <h2 class="subtitle mb-20">Haspels nieuw & jong tweedehands | Stationaire pompinstallaties  
</h2>
